...
// Type: PagedList.Mvc.PagedListRenderOptions
...
namespace PagedList.Mvc
{
    ...
    public class PagedListRenderOptions
    {
        ...
        public PagedListRenderOptions()
        {
            ...
            this.MaximumPageNumbersToDisplay = new int?(10);
            ...
            this.FunctionToDisplayEachPageNumber = (Func<int, string>)null;
            this.ClassToApplyToFirstListItemInPager = (string)null;
            this.ClassToApplyToLastListItemInPager = (string)null;

            this.ContainerDivClasses = (IEnumerable<string>)new string[1]
            {
                "pagination-container"
            };

            this.UlElementClasses = (IEnumerable<string>)new string[1]
            {
                "pagination"
            };
            ...
            this.ATaglElementClasses = (string)null;
        }
        ...
        /// <summary>
        ///  CSS Classes to append to every <a> tag; element in the paging control.
        /// </summary>
        public string ATaglElementClasses { get; set; } = "a";
        ...
        /// </summary>
        /// <example>"Showing items 75 through 100 of 183."</example>
        ...
        /// </summary>
        /// <example>"Showing items {0} through {1} of {2}."</example>
        ...
        public static PagedListRenderOptions EnableUnobtrusiveAjaxReplacing(
          PagedListRenderOptions options,
          AjaxOptions ajaxOptions)
        {
            options.FunctionToTransformEachPageLink = (Func<TagBuilder, TagBuilder, TagBuilder>)((liTagBuilder, aTagBuilder) =>
           {
               string str = liTagBuilder.Attributes.ContainsKey("class") ? liTagBuilder.Attributes["class"] ?? "" : "";
               if (ajaxOptions != null && !str.Contains("disabled") && !str.Contains("active"))
               {
                   foreach (KeyValuePair<string, object> unobtrusiveHtmlAttribute in (IEnumerable<KeyValuePair<string, object>>)ajaxOptions.ToUnobtrusiveHtmlAttributes())
                       aTagBuilder.Attributes.Add(unobtrusiveHtmlAttribute.Key, unobtrusiveHtmlAttribute.Value.ToString());
               }
               liTagBuilder.InnerHtml = ((object)aTagBuilder).ToString();
               return liTagBuilder;
           });
            return options;
        }
          ...
          string id)
        {
            if (id.StartsWith("#"))
                id = id.Substring(1);
            return PagedListRenderOptions.EnableUnobtrusiveAjaxReplacing(new PagedListRenderOptions(), new AjaxOptions()
            {
                HttpMethod = "GET",
                InsertionMode = (InsertionMode)0,
                UpdateTargetId = id
            });
        }
        ...
        public static PagedListRenderOptions EnableUnobtrusiveAjaxReplacing(
          AjaxOptions ajaxOptions)
        {
            return PagedListRenderOptions.EnableUnobtrusiveAjaxReplacing(new PagedListRenderOptions(), ajaxOptions);
        }

        /// <summary>Also includes links to First and Last pages.</summary>
        ...
        /// <summary>Shows only the Previous and Next links.</summary>
        ...
        /// <summary>Shows only links to each individual page.</summary>
        ...
        public static PagedListRenderOptions OnlyShowFivePagesAtATime => new PagedListRenderOptions()
        {
            ...
            DisplayLinkToPreviousPage = PagedListDisplayMode.Always,
            DisplayLinkToNextPage = PagedListDisplayMode.Always,
            MaximumPageNumbersToDisplay = new int?(5)
        };
        ...
        public static PagedListRenderOptions TwitterBootstrapPager => new PagedListRenderOptions()
        {
            ...
            DisplayLinkToNextPage = PagedListDisplayMode.Always,
            DisplayLinkToIndividualPages = false,
            ContainerDivClasses = (IEnumerable<string>)null,
            UlElementClasses = (IEnumerable<string>)new string[1]
          {
        "pager"
          },
            ClassToApplyToFirstListItemInPager = (string)null,
            ClassToApplyToLastListItemInPager = (string)null,
